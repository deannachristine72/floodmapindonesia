<script lang="ts">
  ...
  // Label satuan sesuai mode aktif
...
<div class="space-y-3">
  ...
  {:else if stats}
    <!-- C3: Total Luas — metrik utama yang sebelumnya hilang -->
    <div class="bg-gray-800/60 rounded-lg px-3 py-2.5">
      <div class="text-xs text-gray-500 mb-0.5">Total Luas Deforestasi</div>
      <div class="text-lg font-bold text-teal-400 leading-tight">
    ...
    <div class="grid grid-cols-2 gap-2">
      <div class="bg-gray-800/40 rounded-lg px-2.5 py-2">
    ...
    <!-- Ditampilkan di Peta — label context-aware per mode -->
    {#if showingOnMap > 0}
